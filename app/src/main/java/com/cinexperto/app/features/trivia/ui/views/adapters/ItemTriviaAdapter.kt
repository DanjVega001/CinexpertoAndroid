...
class ItemTriviaAdapter(private val trivias:List<GetTriviasDto>) : RecyclerView.Adapter<TriviaViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TriviaViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return TriviaViewHolder(layoutInflater.inflate(R.layout.item_rv_trivias_one, parent, false))
    }
